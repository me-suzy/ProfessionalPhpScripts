...
$LANG["BookMess6"] = "Welkom op onze site. Hier kun je het gastenboek tekenen";
$LANG["BookMess7"] = "Commentaar";
$LANG["BookMess8"] = "Terug naar het invoerscherm";
$LANG["BookMess9"] = "Geef commentaar op dit bericht";

$LANG["BookMess10"]  = "<br>Bedankt voor je bijdrage.Je bericht is met succes toegevoegd aan het gastenboek.<br>Je gaat nu binnen 2 seconden automatisch terug naar het gastenboek.<br>";
...
# Form
$LANG["FormMess1"]   = "Vul onderstaande velden in om een bericht achter te laten. Velden met een (*) moeten worden ingevuld.";
...
$LANG["FormEnter"]   = "Gastenboek - Onderhoud<br>Voordat je verder kan dien je een geldige loginnaam en wachtwoord in te voeren!";
$LANG["FormButton"]  = "Ga naar";
$LANG["FormPriv"]    = "Priv&eacute; bericht";


# Navigation Bar
$LANG["NavTotal"]   = "Total aantal berichten:";
$LANG["NavRecords"] = "Berichten per pageina:";
$LANG["NavPrev"]    = "Vorige pagina";
$LANG["NavNext"]    = "Volgende pagina";

# Post Errors
$LANG["ErrorPost1"]  = "Je hebt geen naam in gevuld. Ga terug en wijzig dit.";
$LANG["ErrorPost2"]  = "Je bent vergeten het bericht in te vullen. Ga terug en wijzig dit.";
$LANG["ErrorPost3"]  = "Je bericht is te kort of te lang. Ga terug en wijzig dit.";
...
$LANG["ErrorPost7"]  = "Verkeerd bestand type";
$LANG["ErrorPost8"]  = "Sorry! Er komen op het moment te veel berichten tegelijk binnen. Probeer het straks nog eens!";
$LANG["ErrorPost9"]  = "Je IP adress is verbannen!";
$LANG["ErrorPost10"] = "Je bericht bevat woorden die we niet toelaten in dit forum. Ga terug en verander deze.";
$LANG["ErrorPost11"] = "Je hebt geen commentaar in gevuld.";
