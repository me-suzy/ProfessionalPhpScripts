  ...
  <table border="1" width="600" cellspacing="0" bgcolor="#000066" cellpadding="0">
    <tr>
      <td colspan="2" valign="top">
        <p align="center"><font face="Verdana" size="3"><b>CJULTRA v.2.0 SETUP</b></font></td>
    </tr>
    <tr>
...
$query5 = "insert into settings values('$b1','$b2','$b3','$b4','http://www.dailylolita.net','110','0','0','0','0','10','$b12','0','0')";
$result5 = mysql_query($query5);
if(!$result5) error_message(sql_error());
